...
# Specify multi-plot layout
par(mfcol=c(2,2))

# Plot 1
plot(hpc_data$DateTime, hpc_data$Global_active_power, type="n", xlab="", ylab="Global Active Power")
lines(hpc_data$DateTime, hpc_data$Global_active_power)
...
# Plot 3
plot(hpc_data$DateTime, hpc_data$Voltage, type="n", xlab="datetime", ylab="Voltage")
lines(hpc_data$DateTime, hpc_data$Voltage)

# Plot 4
plot(hpc_data$DateTime, hpc_data$Global_reactive_power, type="n", xlab="datetime", ylab="Global_reactive_power")
lines(hpc_data$DateTime, hpc_data$Global_reactive_power)
